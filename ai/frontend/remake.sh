...
# Apply the updated gulpfile
echo "Updating gulpfile.js..."
cat > gulpfile.js << 'EOL'
...
# Run the gulp task
echo "Running gulp to inline assets..."
npx gulp

echo "Process completed! Check dist/frontend/browser/index.html for the inlined content."
